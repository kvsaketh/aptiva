      ...
      >
        <div className="container-xl flex h-[80px] items-center justify-between">
          ...
          <a href="#/" className="group flex items-center" aria-label="Aptiva home">
            <img src="/logo-dark-bg.png" alt="Aptiva Technologies" className="h-[2.31rem] w-auto object-contain transition-transform duration-500 group-hover:scale-[1.04] md:h-[2.695rem]" />
          </a>

    ...
    <footer className="surface-ink-flat relative">
          ...
          <div className="flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-end">
            <div className="max-w-2xl">
              ...
              <p className="lead mt-5 text-white/60">
                Start with one project. Scale across the enterprise. Talk to a team that has delivered for banks, governments and telecoms across 7 global locations.
              </p>
            </div>
      ...
      <div className="container-xl py-16 md:py-20">
        <div className="mb-14 flex flex-col gap-6 border-b border-white/10 pb-10 md:flex-row md:items-center md:justify-between">
          <img src="/logo-dark-bg.png" alt="Aptiva Technologies" className="h-[3.85rem] w-auto object-contain" />
